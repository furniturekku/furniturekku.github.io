...
<section id="home">
    ...
    <div class="kolom">
        ...
        <?php echo maximum_kata(ambil_isi('8'), 50) ?>
        <p><a href="<?php echo buat_link_halaman('8') ?>" class="tbl-pink">See More</a></p>
    </div>
</section>
...
<section id="courses">
    <div class="kolom">
        ...
        <?php echo maximum_kata(ambil_isi('9'), 50) ?>
        <p><a href="<?php echo buat_link_halaman('9') ?>" class="tbl-biru">See More</a></p>
    </div>
